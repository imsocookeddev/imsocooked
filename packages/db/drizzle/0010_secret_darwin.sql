ALTER TABLE "problem_completion" ALTER COLUMN "problemID" SET DATA TYPE uuid USING gen_random_uuid();--> statement-breakpoint
ALTER TABLE "problems_to_categories" ALTER COLUMN "problemID" SET DATA TYPE uuid USING gen_random_uuid();--> statement-breakpoint
